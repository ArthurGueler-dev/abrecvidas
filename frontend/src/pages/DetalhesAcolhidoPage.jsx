...
import { ArrowLeft, Pencil, User, Phone, MapPin, Calendar, Upload } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="card-p flex flex-col items-center text-center gap-4">
          <div className="relative">
            {acolhido.foto_url
              ? <img src={acolhido.foto_url} alt={acolhido.nome} className="w-28 h-28 rounded-full object-cover border-4 border-white shadow-md" />
          ...
          <div className="w-full space-y-2 text-left">
            <Info label="Admissão" valor={acolhido.data_admissao ? new Date(acolhido.data_admissao).toLocaleDateString('pt-BR') : null} />
            {acolhido.data_alta && <Info label="Alta" valor={new Date(acolhido.data_alta).toLocaleDateString('pt-BR')} />}
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="card-p">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <Info label="Data de Nascimento" valor={acolhido.data_nascimento ? new Date(acolhido.data_nascimento).toLocaleDateString('pt-BR') : null} />
          ...
          <div className="card-p">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <Info label="Cidade / UF" valor={acolhido.cidade && acolhido.estado ? `${acolhido.cidade} / ${acolhido.estado}` : acolhido.cidade || acolhido.estado} />
            </div>
          </div>
